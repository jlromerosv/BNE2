...
namespace Drupal\Tests\tmgmt_plata\Functional;

use Drupal\node\Entity\Node;
use Drupal\Tests\tmgmt\Functional\TMGMTTestBase;
use Drupal\tmgmt\Entity\Job;
use Drupal\tmgmt\JobItemInterface;
use Drupal\tmgmt_plata\Plugin\tmgmt\Translator\PlataTranslator;
 ...
 * @group tmgmt_plata
 */
class PlataTranslatorTest extends TMGMTTestBase {
   ...
   * @var array
   */
  public static $modules = array('tmgmt_plata', 'tmgmt_plata_test');
  ...
  public function setUp() {
    ...
    $url = Url::fromUri('base://tmgmt_plata_test', array('absolute' => TRUE))->toString();
   ...
   */
  public function testPlata() {
    $plugin = $this->translator->getPlugin();
    $this->assertTrue($plugin instanceof PlataTranslator, 'Plugin is a PlataTranslator');
  ...
  public function testPlataUi() {
    ...
    $this->assertText(t('The "Plata API key" is not correct.'));
