...
namespace Drupal\tmgmt_plata_eu\Plugin\tmgmt\Translator;
 ...
 * @TranslatorPlugin(
 *   id = "plata_eu",
 *   label = @Translation("Plata EU"),
 *   description = @Translation("Pulsia Plata EU Translator service."),
 *   ui = "Drupal\tmgmt_plata_eu\PlataEuTranslatorUi",
 *   logo = "icons/plata_eu.svg",
 * )
 */
class PlataEuTranslator extends TranslatorPluginBase implements ContainerFactoryPluginInterface, ContinuousTranslatorInterface
{
   ...
   * @var string
   */
/*  protected $translatorUrl = 'http://se-moses.redsara.es/TranslatorService_v2/Translator_v2';*/
  protected $translatorUrl = 'https://moses.redsara.es/TranslatorService_v2/Translator_v2';
   ...
   */
  protected function plata_euRequestTranslation(Job $job, $q)
  {
  ...
  public function getSupportedRemoteLanguages(TranslatorInterface $translator)
  {
    ...
    try {
      ...
      $languages = array("es" => "es", "en" => "en", "eu" => "eu");
      /*
  ...
  protected function doRequest(Translator $translator, $action, array $request_query = array(), array $options = array())
  {
    ...
    try {
      if ($response->getStatusCode() == 200) {
        ...
        \Drupal::logger('Pulsia PLATA Eu response')->notice(serialize($response));
      ...
      if ($bloqueado == false) {
        ...
        try {
          ...
          foreach (array_chunk($q, $this->qChunkSize) as $_q) {
            ...
            $result = $this->plata_euRequestTranslation($job, $_q);
